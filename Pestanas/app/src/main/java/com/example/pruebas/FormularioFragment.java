...
public class FormularioFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        enviar = (Button) vista.findViewById(R.id.button);
        correo = (TextView) vista.findViewById(R.id.editTextText2);
        enviar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getActivity(), "Datos enviados de " + correo.getText().toString(), Toast.LENGTH_SHORT).show();
            }
        });
        return vista;
    }
